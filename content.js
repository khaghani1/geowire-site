...
const GEOWIRE = {
  ...
  farsiIntel: {
    ...
    signals: [
      {
        id: 'regime-unity',
        title: 'Regime Unity Fractures',
        titleFa: 'شکاف در انسجام نظام',
        category: 'POLITICAL',
        severity: 'HIGH',
        en: 'IRGC and Rouhani-aligned technocrats diverging on ceasefire terms. Economic pressure accelerating internal splits.',
        fa: 'سپاه پاسداران و تکنوکرات‌های هم‌راستا با روحانی در مورد شرایط آتش‌بس اختلاف دارند. فشار اقتصادی شکاف‌های داخلی را تسریع می‌کند.',
        source: 'بی‌بی‌سی فارسی',
        sourceEn: 'BBC Persian',
        confidence: 'multisource',
        timestamp: '2026-03-25T10:00Z',
        watchFor: 'Khamenei public statements on ceasefire — any softening signals delegation of authority',
      },
      {
        id: 'hormuz-partial',
        title: 'Hormuz Partial Reopening Signals',
        titleFa: 'سیگنال‌های بازگشایی جزئی هرمز',
        category: 'MILITARY',
        severity: 'MEDIUM',
        en: 'IRGC naval commander hinted at "humanitarian corridor" possibility in private Oman-brokered talks. Not confirmed publicly.',
        fa: 'فرمانده دریایی سپاه در مذاکرات خصوصی با میانجیگری عمان به امکان "کریدور بشردوستانه" اشاره کرده است. به صورت عمومی تأیید نشده.',
        source: 'ایران اینترنشنال',
        sourceEn: 'Iran International',
        confidence: 'singlesource',
        timestamp: '2026-03-25T07:30Z',
        watchFor: 'Any IRGC commander press conference; Oman FM travel schedule',
      },
      {
        id: 'economic-stress',
        title: 'Domestic Economic Collapse Accelerating',
        titleFa: 'تسریع فروپاشی اقتصادی داخلی',
        category: 'ECONOMIC',
        severity: 'CRITICAL',
        en: 'Rial hit 950,000/USD (record). Fuel rationing in Tehran. University campuses quiet — feared student protests. Bread subsidies cut 40%.',
        fa: 'ریال به ۹۵۰,۰۰۰ در برابر دلار رسید (رکورد). جیره‌بندی سوخت در تهران. محیط دانشگاه‌ها آرام — نگرانی از اعتراضات دانشجویی. یارانه نان ۴۰٪ کاهش یافت.',
        source: 'رادیو فردا',
        sourceEn: 'Radio Farda',
        confidence: 'multisource',
        timestamp: '2026-03-25T09:00Z',
        watchFor: 'Tehran bazaar shutdowns; labor strikes in Khuzestan oil sector',
      },
      {
        id: 'ghalibaf-positioning',
        title: 'Ghalibaf Consolidates Power',
        titleFa: 'غلامحسین محمدباقر قالیباف قدرت را تحکیم می‌کند',
        category: 'POLITICAL',
        severity: 'HIGH',
        en: 'Ghalibaf elevated to de facto state leader per GeoWire assessment. IRGC loyalists given key ministry posts. Raisi-era officials being sidelined.',
        fa: 'قالیباف به عنوان رهبر عملی دولت ارتقا یافته است — ارزیابی جیووایر. وفاداران سپاه به پست‌های کلیدی وزارت منصوب شدند. مقامات دوران رئیسی کنار گذاشته می‌شوند.',
        source: 'جیووایر',
        sourceEn: 'GeoWire Model',
        confidence: 'inferred',
        timestamp: '2026-03-24T12:00Z',
        watchFor: 'IRGC Quds Force command changes; Majlis emergency session agenda',
      },
      {
        id: 'proxy-escalation',
        title: 'Proxy Network Activation Risk',
        titleFa: 'خطر فعال‌سازی شبکه نیابتی',
        category: 'MILITARY',
        severity: 'HIGH',
        en: 'Hezbollah and Houthi operations increasing coordination per signals. Iraqi PMF placed on elevated readiness. Risk of Western theater expansion.',
        fa: 'عملیات حزب‌الله و حوثی‌ها هماهنگی را افزایش می‌دهند. نیروهای حشد شعبی عراق در آمادگی بالاتری قرار گرفتند. خطر گسترش تئاتر غربی.',
        source: 'میدل ایست آی',
        sourceEn: 'Middle East Eye',
        confidence: 'multisource',
        timestamp: '2026-03-24T18:00Z',
        watchFor: 'Hezbollah rocket trajectories; Iraqi PMF public mobilization calls',
      },
    ],

    glossary: [
      { term: 'سپاه پاسداران', transliteration: 'Sepāh-e Pāsdārān', en: 'IRGC', definition: 'Islamic Revolutionary Guard Corps — parallel military; controls Quds Force, proxy networks, and strategic weapons.' },
      { term: 'آتش‌بس', transliteration: 'Ātash-bas', en: 'Ceasefire', definition: 'Formal halt to hostilities. Distinct from "truce" (هدنه) which is temporary.' },
      { term: 'تنگه هرمز', transliteration: 'Tangeh-ye Hormoz', en: 'Strait of Hormuz', definition: '21% of global oil trade passes here. IRGC can mine and block within hours.' },
      { term: 'بسیج', transliteration: 'Basij', en: 'Basij Militia', definition: 'Paramilitary volunteer force under IRGC. Used for domestic suppression and frontline cannon fodder.' },
      { term: 'رهبری', transliteration: 'Rahbari', en: 'Supreme Leadership', definition: 'Refers to Khamenei\'s office. Decisions require Rahbari endorsement to be binding.' },
      { term: 'جنگ نیابتی', transliteration: 'Jang-e Niyābati', en: 'Proxy War', definition: 'Iran\'s strategic doctrine — fight via Hezbollah, Houthis, PMF rather than directly.' },
      { term: 'مذاکره', transliteration: 'Mozākereh', en: 'Negotiation', definition: 'State-level talks. Iran distinguishes between "mذاکره" (legitimate talks) and "تسلیم" (surrender).' },
      { term: 'اقتصاد مقاومتی', transliteration: 'Eqtesād-e Moqāvemati', en: 'Resistance Economy', definition: 'Khamenei doctrine: self-sufficiency under sanctions. Increasingly failing under war conditions.' },
    ],

    sourceTiers: [
      { name: 'بی‌بی‌سی فارسی', nameEn: 'BBC Persian', tier: 1, tierLabel: 'High', bias: 'Neutral-Western', notes: 'Best for regime internal politics; strong Tehran contacts.' },
      { name: 'ایران اینترنشنال', nameEn: 'Iran International', tier: 1, tierLabel: 'High', bias: 'Anti-regime', notes: 'Best for military ops and IRGC leaks; London-based; some exile bias.' },
      { name: 'رادیو فردا', nameEn: 'Radio Farda', tier: 1, tierLabel: 'High', bias: 'Neutral-Western', notes: 'RFE/RL funded; strong economic reporting; trusted on street-level data.' },
      { name: 'تسنیم', nameEn: 'Tasnim News', tier: 3, tierLabel: 'State', bias: 'IRGC-aligned', notes: 'Read for IRGC messaging intent, not facts. Mirroring official lines.' },
      { name: 'ایرنا', nameEn: 'IRNA', tier: 3, tierLabel: 'State', bias: 'Government', notes: 'Official state wire. Use for formal announcements only. Omissions more useful than content.' },
      { name: 'میدل ایست آی', nameEn: 'Middle East Eye', tier: 2, tierLabel: 'Medium', bias: 'Qatari-funded', notes: 'Strong on proxy/Hezbollah. Qatar ties create Gulf-favorable framing.' },
    ],
  },
