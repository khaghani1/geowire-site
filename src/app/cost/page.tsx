...
const COMPARISONS = [
  ...
  { amount: 12, label: 'Chipotle burritos', icon: '🌯' },
];
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
        ...
        {result && (
          <>
            <div className="bg-bg-2 border border-accent-red/30 rounded-xl p-8 mb-8 text-center">
              ...
              <div className="font-mono text-5xl sm:text-6xl lg:text-7xl font-bold cost-counter mb-4">
                $${Math.round(liveCost).toLocaleString()}
              </div>
              <p className="font-mono text-xs text-tx-3 mb-6">...and counting</p>
              ...
              <div className="flex flex-wrap justify-center gap-3">
                <a
                  ...
                  className="bg-bg-4 hover:bg-bg-3 text-tx-0 px-6 py-2.5 rounded-lg font-mono text-sm transition-colors"
                >
                  Share on X
                </a>
                <button
            ...
            <div className="bg-bg-2 border border-border rounded-xl p-6 sm:p-8 mb-8">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
                ...
                <div>
                  <div className="font-mono text-xl font-bold text-accent-orange">$1.75B</div>
                  <div className="font-mono text-[10px] text-tx-3">PER DAY</div>
                </div>
                <div>
        ...
        <div className="bg-bg-2 border border-border rounded-xl p-6 sm:p-8">
          ...
          <div className="text-tx-2 text-sm space-y-3 leading-relaxed">
            ...
            <p>
              The estimated war cost of $1.75 billion per day is based on Department of Defense operational cost estimates for
